...
import Pinecone.Framework.Util.Summer.http.CommonHttpEntityParser;
import Pinecone.Framework.Util.Summer.http.HttpEntityParser;
import Pinecone.Framework.Util.Summer.prototype.HostSystem;
import Pinecone.Framework.Util.Summer.prototype.RouterDispatcher;
...
public class ArchHostSystem implements HostSystem {
    ...
    private void parseConfig()  throws IOException {
        this.mGlobalConfig = new JSONObject( this.readFileContentAll( this.mszConfigPath )  );
    }
