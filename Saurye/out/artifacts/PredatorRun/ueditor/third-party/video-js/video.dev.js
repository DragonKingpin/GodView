...
/**
 * Basic Player instance options, surfaced from vjs.Player.prototype.options_
...
vjs.Button.prototype.createEl = function(type, props){
  ...
  props = vjs.obj.merge({
    ...
    innerHTML: '<div class="vjs-control-content"><span class="vjs-control-text">' + (this.buttonText || 'Need String') + '</span></div>',
    role: 'button',
...
/**
 * @fileoverview String Tracks
 * String tracks are tracks of timed text events.
...
/* String Track Display
============================================================================= */
// Basic container for both subtitle and captions text. Simple div container.
